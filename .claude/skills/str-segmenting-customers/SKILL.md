...
| Source | Purpose |
|--------|---------|
| `strategy/canvas/03.opportunity.md` | TAM/SAM/SOM data (required for segment sizing) |
| `strategy/canvas/01.context.md` | KBOS framework and strategic context (optional) |
| `strategy/canvas/05.problem.md` | Problem severity data for pain validation (optional) |

## Writes

| Output | Content |
|--------|---------|
| `strategy/canvas/04.segments.md` | Segment definitions with observable filters, sizing, pain scores, and prioritization |
...
Use strategist to establish market sizing first.
```
...
### 3. Define Observable Filters [R]

**Evaluation method:** Classify filters against valid/invalid enumerated examples (company size, industry, tech, geography, behavior vs psychographics).
...
See [knowledge/growth/nar-observable-filters.md](../../../knowledge/growth/nar-observable-filters.md) for comprehensive examples.

### 4. Score Pain Intensity [R]

**Evaluation method:** Map evidence signals to pain score lookup table (1-5 scale).
...
See [knowledge/strategy/segment-scoring.md](../../../knowledge/strategy/segment-scoring.md) for detailed rubric.

### 5. Estimate Segment Size [K]
...
### 6. Prioritize Segments [R]

**Evaluation method:** Apply prioritization formula (Pain × WTP × Accessibility), rank by score.
...
- **Filter examples**: [knowledge/growth/nar-observable-filters.md](../../../knowledge/growth/nar-observable-filters.md)
- **Scoring rubric**: [knowledge/strategy/segment-scoring.md](../../../knowledge/strategy/segment-scoring.md)