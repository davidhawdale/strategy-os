---
name: str-analyzing-competition
...
| Source | Purpose |
|--------|---------|
| `strategy/canvas/05.problem.md` | Problems being solved define competitive frame (required) |
| `strategy/canvas/04.segments.md` | Target segment defines competitive context (required) |
| `strategy/canvas/01.context.md` | Industry dynamics and context (optional) |

## Writes

| Output | Content |
|--------|---------|
| `strategy/canvas/06.competitive.md` | Competitive landscape, positioning matrix, and gaps |
...
### Step 2: Identify Direct Competitors [K]
...
**Evaluation method:** Classify alternatives into enumerated categories (manual/adjacent/service/DIY/status quo).
...
### Step 4: Profile Each Competitor [K]
...
### Step 5: Build Positioning Matrix [K]
...
### Step 6: Identify Positioning Gaps [K]
...
### Step 7: Assess Competitive Threats [R]

**Evaluation method:** Score each competitor on threat dimensions (response speed, resources, switching costs, brand, expansion) using enumerated criteria, classify as high/medium/low.
