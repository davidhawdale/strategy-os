...
Created: 2026-04-24
Last Reviewed: 2026-05-05 (Strategist CHALLENGE Pass 1 — incorporates P&J product briefing T1 evidence)
...
**Evidence:**
- [WEB_RESEARCH] [T1] 2026-04-24 -- Wikipedia / Southern Reporter: paid print circulation fell from c.12,500 (2013) to c.3,352 (2023), 73% decline -- direct signal that the legacy local-news product in this geography is failing
- [WEB_RESEARCH] [T1] 2026-04-24 -- Press Gazette: DC Thomson subscription revenue +2% YoY to £40.6m FY24, only growing revenue line -- direct signal that the reader-pay model is the right structural bet, in the right region
- [WEB_RESEARCH] [T1] 2026-04-24 -- WAN-IFRA Nov 2023: DC Thomson grew digital subs from <1,000 (2019) to >30,000 (Nov 2023) across two regional patches (Aberdeen + Dundee) -- proof the operating model works at regional-city scale; question is whether it works at dispersed-rural scale
- [WEB_RESEARCH] [T1] 2026-04-24 -- Press Gazette / Newsquest: 135,000 paid subs across 125 brands ~ 1,080/brand average -- a viable but low per-title floor in the UK regional market
- [WEB_RESEARCH] [T2] 2026-04-24 -- Newsquest data: 21% of subscriber conversions from court reports, 20% from sport -- behavioural evidence that civic-accountability and community-identity content drive conversion in regional markets, supporting P2/P3 alternatives
- [COMPETITIVE_ANALYSIS] [T1] 2026-04-24 -- Border Telegraph (Newsquest, £4.99/mo, £52/yr) and Southern Reporter (Iconic Media) operate at weekly cadence with no daily competitor -- coverage gap is observable
- [WEB_RESEARCH] [T2] 2026-04-24 -- Scottish Borders Council research data: 25-44 age cohort declined 22.9% (2001-2021); 45-64 = 30.2% of pop; 5th-highest % over 65 in Scotland -- demographic profile is favourable for paid local news (older, settled, civic-engaged demographics over-index on news subscription)
- [OBSERVATION] [T1] 2026-05-05 -- DC Thomson P&J operates *free weekly newsletters* for Elgin (Moray, c.95k pop), Inverness (city c.50k / area c.85k), and Oban & Hebrides (very dispersed, c.50k combined) — geographies broadly comparable in density and dispersion to the Borders — but does NOT operate a *separate paid subscription title* for any of them. They are served editorially within the regional P&J product. This is informative on the threshold question: the observed pattern in DCT's own portfolio is "low-density area = newsletter inside the regional title", not "low-density area = standalone paid title". Source: research/press-and-journal/pj-product-briefing-2026-05-05.md, pj-website-newsletters.png. Strengthens the case that a free Borders newsletter (Phase 0) is a coherent first move; weakens any unexamined assumption that a standalone Borders subscription brand is the only viable form. The problem (daily-cadence local news gap) may be real but the *product form* that resolves it is not yet uniquely determined by the evidence.

**Research Sources:**
- [T1] 2026-04-24 -- https://en.wikipedia.org/wiki/Southern_Reporter_(newspaper) -- circulation history of Southern Reporter
- [T1] 2026-04-24 -- https://pressgazette.co.uk/media_business/dc-thomson-revenue-2024/ -- DCT FY24 financials
- [T1] 2026-04-24 -- https://wan-ifra.org/2023/11/dc-thomson-new-focus-on-communities-brings-big-gains-in-paying-digital-subscribers/ -- DCT subscriber trajectory and operating model
- [T1] 2026-04-24 -- https://pressgazette.co.uk/paywalls/newsquest-hits-100000-digital-subscribers/ -- Newsquest per-brand benchmark
- [T1] 2026-04-24 -- https://www.scotborders.gov.uk/strategies-plans-policies/research-data-scottish-borders-topic -- Borders demographics
- [T1] 2026-04-24 -- https://www.bordertelegraph.com/subscribe/ -- competitor pricing
- [T1] 2026-04-24 -- https://pressgazette.co.uk/publishers/regional-newspapers/focus-on-local-not-trending-news-fuels-record-newsquest-digital-growth/ -- conversion-driving content categories
...
**Update Rationale:** CHALLENGE pass — added T1 evidence on DCT's observed newsletter-geography pattern (Elgin, Inverness, Oban). Refined load-bearing assumption on cadence and extended kill condition to distinguish "problem real but resolved by newsletter" from "problem real and requires paid daily product". Confidence state unchanged at RESEARCHED. Ground-truth gap (G-01: resident interviews) still binds.
...
**Evidence:**
- [WEB_RESEARCH] [T1] 2026-04-24 -- Scottish Borders Council demographic data: 45-64 cohort = 30.2% (above Scottish average), 5th-highest % over 65 in Scotland -- target demographic concentrated
- [WEB_RESEARCH] [T2] 2026-04-24 -- Newsquest data: 21% court conversions, 20% sport conversions -- segment-relevant content categories validated as conversion drivers
...
- [WEB_RESEARCH] [T2] 2026-04-24 -- Project Gigabit Borders: 11,000 premises in current contract, ongoing rollout -- digital-access constraint is being actively removed for the target geography
- [OBSERVATION] [T1] 2026-05-05 -- DCT P&J's geographic coverage extends to Inverness (city c.50k / area c.85k), Moray (c.95k pop), Argyll & Bute / Oban (c.85k area) and Western Isles (c.26k) — three of which are served by free local newsletters but none by a separate paid title. Borders population c.117,000 is *larger* than each of these individually but smaller than the Aberdeen+Aberdeenshire core (c.260k+) where the full P&J subscription is anchored. This calibrates the *minimum viable segment* question: DCT's revealed-preference threshold for "standalone paid title" sits above c.95k (Moray) and below c.260k (NE Scotland core). The Borders falls inside that band. This neither confirms nor falsifies viability; it suggests Borders is at or near the lower threshold and that DCT's observed pattern would default to "free newsletter inside an existing title" unless a paid case is made. Source: research/press-and-journal/pj-product-briefing-2026-05-05.md, pj-website-9-geos-coverage.png.
- [OBSERVATION] [T1] 2026-05-05 -- P&J app onboarding (pj-app-onboarding-4.PNG) shows users can follow multiple geographic topics simultaneously (Aberdeen, Aberdeenshire, Highlands, Moray, Inverness, Argyll & Bute, Western Isles, Shetland, Orkney) within one app instance — the segment-targeting infrastructure (per-locale content streams reaching dispersed audiences from one app) is built and operational. This is a *capability* signal, not a *segment* signal, but it removes one barrier to serving Borders as a follow-able topic.

**Research Sources:**
- [T1] 2026-04-24 -- Scottish Borders Council research portal -- demographic profile
- [T1] 2026-04-24 -- Wikipedia / Southern Reporter -- legacy local-news subscriber footprint
- [T1] 2026-04-24 -- Project Gigabit / Borders broadband rollout sources -- digital-access trajectory
- [T2] 2026-04-24 -- Newsquest conversion-driver data -- content-category benchmarks for conversion
...
**Last Updated:** 2026-05-05
**Update Rationale:** CHALLENGE pass — added two T1 evidence items (DCT geographic-coverage threshold calibration; multi-locale app capability). Refined size-range assumption with cross-reference to DCT's observed minimum-viable-segment threshold (c.95k Moray = newsletter-only; c.260k NE = paid title; c.117k Borders = borderline). Confidence state unchanged at RESEARCHED. G-04 (NRS data pull) is more urgent post-CHALLENGE. Kill condition unchanged.
...
**Evidence:**
- [WEB_RESEARCH] [T1] 2026-04-24 -- Press Gazette: P&J digital monthly £5.99 -- direct anchor for ARPU range (NOTE: superseded 2026-05-05 by T1-confirmed live tier structure of £4.99 / £8.99 / £23.99 — the £5.99 figure was either historical, partial, or referred to a different SKU)
- [OBSERVATION] [T1] 2026-05-05 -- P&J live subscribe page (research/press-and-journal/pj-products-pricing-web-app-epaper.png) confirms three tiers: Sport Pack £4.99/mo (£49.99/yr), Web Pack £8.99/mo (£89.99/yr), Web+ePaper £23.99/mo (£239.99/yr). Annual saving c.16-17%. Web Pack is the "main" tier and is the correct price anchor for a Borders Web tier. Source: research/press-and-journal/pj-product-briefing-2026-05-05.md.
- [OBSERVATION] [T1] 2026-05-05 -- Evening Express (DCT, Aberdeen city only): single ePaper-focused subscription at £14.99/mo / £144.99/yr; print circulation 9,449 (2023). This is the single most relevant comparator for a Borders product because Evening Express is single-coverage (one city/area) just as Borders would be. Calibrates the lower bound for a Borders ePaper-tier price. Source: research/press-and-journal/pj-product-briefing-2026-05-05.md "Sister Title" section.
- [OBSERVATION] [T1] 2026-05-05 -- P&J does NOT bundle print with digital — print is sold separately via DC Thomson print shop at indicative ~£610/yr. The v1 register's bundle-pricing assumption (£8.99-£12.99/mo for digital+print) does not match the reference product. Material correction. Source: research/press-and-journal/pj-product-briefing-2026-05-05.md "Tiers and Pricing" section.
- [OBSERVATION] [T1] 2026-05-05 -- Pricing discrepancy on live P&J site: main subscribe page quotes £23.99/mo for top tier; ePaper landing page quotes £21.99/mo for what appears to be the same product. Indicates DCT is actively managing top-tier pricing (A/B test, price rise in progress, or legacy promotional rate). Informational — does not change the Borders model directly but is a marker that subscription economics are not stable inputs at the reference product. Source: research/press-and-journal/pj-product-briefing-2026-05-05.md "Pricing Discrepancies" section.
- [COMPETITIVE_ANALYSIS] [T1] 2026-04-24 -- Border Telegraph £4.99/mo, £52/yr -- competitive floor for this geography
- [WEB_RESEARCH] [T1] 2026-04-24 -- NUJ minimum regional reporter £27k; PG average £32.7k -- editorial cost basis
- [WEB_RESEARCH] [T2] 2026-04-24 -- DCT scaled from <1,000 to >30,000 subs across two regional patches (combined population c.640k) over 4 years -- precedent for c.5% market penetration as plausible end-state at scale
- [WEB_RESEARCH] [T2] 2026-04-24 -- Newsquest 135k subs across 125 brands (avg c.1,080/brand) -- per-title floor benchmark; cautionary anchor that not every regional title scales beyond ~1,000

**Research Sources:**
- [T1] 2026-04-24 -- Press Gazette UK digital news subscriptions cost 2025 -- pricing benchmarks
- [T1] 2026-04-24 -- Press Gazette regional newsroom salary -- editorial cost basis
- [T1] 2026-04-24 -- Stripe published payment processing rates -- variable cost
- [T2] 2026-04-24 -- WAN-IFRA DCT case study -- subscription operating-model precedent
- [T2] 2026-04-24 -- Pugpig DCT launch case -- platform reuse (zero marginal platform cost)
...
**Evidence:**
- [WEB_RESEARCH] [T1] 2026-04-24 -- Southern Reporter circulation collapse (12,500 -> 3,352, 73% decline) -- structural failure of the weekly local product creates the gap the VP exploits
- [WEB_RESEARCH] [T1] 2026-04-24 -- DCT subscription revenue +2% YoY to £40.6m FY24 -- the differentiator (DCT operating model) is a genuinely working machine, not aspirational
- [WEB_RESEARCH] [T2] 2026-04-24 -- Newsquest court reports = 21% of conversions, sport = 20% -- the content categories the VP centres are validated as conversion drivers in regional news
- [COMPETITIVE_ANALYSIS] [T1] 2026-04-24 -- No daily competitor in Borders; weekly competitors operate at thin editorial scale (typically 1-3 FTE per title under current owners) -- the editorial-scale differentiator is real
- [OBSERVATION] [T1] 2026-05-05 -- DCT P&J operates 4 geographic newsletters (Aberdeen+Aberdeenshire, Elgin/Moray, Inverness, Oban+Hebrides) at varying weekly frequencies (1-3x/week), all FREE, alongside a Daily flagship newsletter (Mon-Fri). This is informative on the cadence claim: DCT's *observed* cadence in low-density areas is "weekly newsletter", not "daily product". The "daily" differentiator vs Border Telegraph (weekly print) holds, but only if the Borders product is in fact daily — and DCT's own pattern in similarly dispersed markets is *not* daily at the local level. The VP cadence clause now needs to specify: "daily *Borders-specific reporting*" — not just "daily newsletter delivery" — to be meaningfully differentiated from a free weekly newsletter pivot. Source: research/press-and-journal/pj-product-briefing-2026-05-05.md "Newsletters" section.
...
**Last Updated:** 2026-05-05
**Update Rationale:** CHALLENGE pass — added T1 evidence on DCT's observed newsletter cadence in dispersed Scottish geographies (weekly, not daily). Refined the differentiator clause to require *daily Borders-specific reporting* (not just daily delivery cadence) to be meaningfully distinct from a newsletter pivot. Extended the WTP assumption to test three product configurations (free newsletter vs paid daily vs paid section in existing brand), not just the binary v1 framing. Confidence state unchanged at RESEARCHED.
...
**Last Updated:** 2026-05-05
**Update Rationale:** CHALLENGE pass — added required-condition on brand-architecture decision (separate brand vs section in existing brand). Added new T2 assumption on multi-locale capability per app-onboarding evidence. Architecture choice (TRADITIONAL subscription) unchanged. Support state unchanged at PROPOSED. Gap Definer must re-validate.
...
**Last Updated:** 2026-05-05
**Update Rationale:** CHALLENGE pass — material restructuring of MVP into two stages (Phase 0 Newsletter MVP + Stage 2 Paid Product MVP) justified by T1 evidence of DCT's observed newsletter-as-entry-point pattern in dispersed Scottish geographies. Print + digital bundle removed (does not exist in reference product). Pricing tier structure revised to two tiers per T1 evidence. Adequacy criteria extended to include Phase 0 thresholds. Support state unchanged at PROPOSED. Gap Definer must re-validate the two-stage MVP and the assumption that the Phase 0 newsletter does not poison the Stage 2 paid pitch.
...
- Proof points (paid, 3 max — CHALLENGE-revised 2026-05-05):
  1. Daily reporting from a c.5-person Borders newsroom -- more local journalists in the Borders than any current title
  2. Built on the same operating model that grew Press & Journal and The Courier digital subscriptions to 30,000+ in four years
  3. From £7.99/month (or £79.99/year), with a Web + ePaper option at £14.99/month — anchored on DCT's existing P&J pricing structure (was: "£4.99/month — less than your weekly print habit". Revised because the £4.99 figure mis-anchored on the competitor floor, not the DCT reference Web Pack of £8.99/mo. The competitive-floor framing also gave away pricing power. Borders should price on its own value, not as the cheapest option.)
...
**Last Updated:** 2026-05-05
**Update Rationale (Section 7):** CHALLENGE pass — added Phase 0 (Newsletter Validation, Months -3 to 0) justified by T1 evidence of DCT's observed newsletter-as-entry-point pattern in dispersed Scottish geographies. Phase 1 budget and KPIs revised to inherit Phase 0 newsletter list as a near-zero-marginal-cost acquisition channel. Pricing in messaging framework updated to T1-anchored Web Pack (£7.99/mo) rather than the v1 Border Telegraph competitor floor (£4.99/mo). Awareness-level CTAs split across Phase 0 (free newsletter) and Stage 2 (paid trial) where appropriate. Constraints table revised to remove print-bundle assumption and reflect Phase 0 budget. Support state unchanged at PROPOSED. Gap Definer must re-validate the Phase 0 design and the assumption that the free newsletter does not poison the Stage 2 paid pitch (a real risk that should be tested).
