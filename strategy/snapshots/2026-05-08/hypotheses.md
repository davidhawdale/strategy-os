...
- [OBSERVATION] [T1] 2026-05-05 -- research/press-and-journal/pj-product-briefing-2026-05-05.md: DCT operates free newsletters for Elgin, Inverness sub-areas, and Oban — these are acquisition and engagement tools within the P&J paid subscription ecosystem, not standalone products. **CORRECTION 2026-05-08:** The prior reading of this observation as "newsletter = product ceiling for low-density areas" was factually wrong. P&J operates a paid daily subscription across ALL those geographies via 6 geographic editions; the newsletters are funnel tools within that paid product, not replacements for it.
- [OBSERVATION] [T1] 2026-05-08 -- research/press-and-journal/pj-6-editions-coverage.png: P&J 6-edition map with per-edition daily circulation: Aberdeen City 11,070 / Aberdeenshire 15,210 / North-east 8,909 / Moray 8,834 / Inverness 6,018 / Highlands & Islands 13,755. Total daily circulation 63,796; weekly readership 285,000; daily readership 161,000. Moray (~100k population, 8,834 daily print circ) is the operational analog for Borders (~117k population) — confirms DCT's one-brand, multi-edition model is viable at Borders population scale within an existing paid product.
...
- [T1] 2026-05-08 -- research/press-and-journal/pj-6-editions-coverage.png -- P&J 6-edition map: per-edition daily circulation and weekly readership; total daily circ 63,796; Moray (~100k pop, 8,834 circ) confirmed operational analog for Borders; governor correction source
...
- [B] [T2] Borders residents experience weekly-cadence as inadequate for local news consumption [LOAD-BEARING] [BLAST:HIGH]
  ...
  -> CHALLENGE 2026-05-08: Weakening withdrawn. The 2026-05-05 note was based on a factual error: DCT does operate a paid daily product (P&J) across Elgin, Inverness, and Oban geographies — the newsletters in those sub-areas are acquisition and engagement tools within P&J's paid ecosystem, not a separate product that substitutes for paid. The P&J 6-edition map (pj-6-editions-coverage.png) confirms this: Moray (~100k pop, 8,834 daily print circ) is the operational analog for Borders and is served by P&J as a paid title. Assumption status remains OPEN pending T3 resident interview evidence, but the DCT-practice weakener from 2026-05-05 is fully withdrawn. The extended kill condition from 2026-05-05 is superseded — see Kill Condition (revised 2026-05-08).
...
**Kill Condition (revised 2026-05-08 — supersedes 2026-05-05 extension):** The 2026-05-05 extension — which framed "free newsletter preferred" as a kill signal — was based on a misreading of DCT's operating model and is withdrawn. Newsletters in Elgin, Inverness sub-areas, and Oban are funnel tools within P&J's paid ecosystem; "free newsletter" and "paid product" are not alternatives in DCT's model, they are a sequence. The relevant distinction for interview probing is not *paid vs free* but *brand architecture*: whether residents would subscribe under a Borders-specific brand or under the P&J / Courier brand extended southward. Both paths produce paid subscription revenue; neither kills the unit-economics hypothesis. G-01 interview script should therefore probe brand-identification and geographic-product framing, not format preference.

**Last Updated:** 2026-05-08

**Update Rationale:** 2026-05-08 CHALLENGE Pass 3 — Governor correction (verbal, 2026-05-08). Factual error in Pass 2 evidence interpretation identified and corrected:
- CORRECTED: The 2026-05-05 observation that DCT's newsletter pattern in Elgin/Inverness/Oban implied a "paid product ceiling" for low-density geographies was wrong. P&J operates a paid daily subscription across ALL those geographies via 6 geographic editions; newsletters are acquisition tools within that paid ecosystem, not standalone products substituting for paid.
- ADDED: P&J 6-edition coverage map (research/press-and-journal/pj-6-editions-coverage.png) — per-edition daily circulation: Aberdeen City 11,070 / Aberdeenshire 15,210 / North-east 8,909 / Moray 8,834 / Inverness 6,018 / Highlands & Islands 13,755. Moray (~100k pop, 8,834 circ) confirmed as operational analog for Borders (~117k pop).
- REVERSED: Load-bearing assumption [B] (cadence) weakening from 2026-05-05 withdrawn. The DCT-practice weakener was based on the factual error.
- REWRITTEN: Kill Condition (extended 2026-05-05) superseded. The "free newsletter preferred = kill signal" framing was wrong; newsletters and paid products are a sequence in DCT's model, not alternatives. G-01 interview probe reoriented: test brand-architecture preference (Borders-specific brand vs P&J/Courier extended southward), not format preference (paid vs free).

Net effect on confidence: RESEARCHED state unchanged. Problem claim modestly strengthened — DCT's Moray edition provides direct operational precedent at Borders population scale. Architecture question (E-03) sharpened: the choice is "extend existing title southward as a geographic edition" vs "new standalone Borders title", both paid subscription models. Kill condition checked: not crossed. The correction removes a spurious extension of the kill condition; the primary kill condition (resident interviews below felt-deficit and WTP thresholds) is unchanged.

**Prior Update (2026-05-06):** 2026-05-06 CHALLENGE Pass 2 — Added four T1 evidence items from fresh competitive intelligence:
